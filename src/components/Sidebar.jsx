    ...
    >
      <div className="flex justify-between -translate-y-8 w-full h-[120px] overflow-hidden">
        ...
        <MenuIcon
          ...
          className="mt-14 mr-2 ml-5 duration-200 ease-in-out transition-all active:scale-[.95] cursor-pointer"
        />
      </div>
      <div className="w-full h-[calc(100vh-120px)] flex flex-col justify-between">
        <ul className="pl-2 flex flex-col gap-1 overflow-hidden">
          <li className="p-4 flex items-center font-inter text-[.9rem] text-gray-700 hover:bg-slate-300 bg-slate-300 cursor-pointer rounded-tl-lg rounded-bl-lg transition-all duration-300 ease-out gap-4">
            <HomeIcon sx={{ fontSize: 19 }} />
            Dashboard
          </li>
          <li className="p-4 flex items-center font-inter text-[.9rem] text-gray-700 hover:bg-slate-300 cursor-pointer rounded-tl-lg rounded-bl-lg transition-all duration-300 ease-out gap-4">
